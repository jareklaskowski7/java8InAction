//: chapter10/ReadPositiveIntParam.java
...
public class ReadPositiveIntParam {
    ...
    public static int readDurationImperative(Properties props, String name) {
        ...
        if (value != null) {
            try {
                ...
                System.out.println("Number Format Exception caught in readDurationImperative()");
            }
        }
        return 0;
    }
    ...
    public static Optional<Integer> s2i(String str) {
        try {
            return of(Integer.parseInt(str));
        } catch (NumberFormatException e) {
            System.out.println("Number Format Exception caught in s2i()");
            return empty();
        }
    }
}
